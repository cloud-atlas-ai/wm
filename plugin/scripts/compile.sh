...
# Run wm hook compile, passing stdin through
# wm hook compile reads the hook JSON from stdin and outputs HookResponse JSON
wm hook compile 2>/dev/null || exit 0
